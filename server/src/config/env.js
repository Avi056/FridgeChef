...
export const env = {
  ...
  clientUrl: process.env.CLIENT_URL || "https://fridgechef-gl2o.onrender.com",
  ...
  googleCallbackUrl:
    ...
    process.env.GOOGLE_CALLBACK_URL || "https://fridgechef-gl2o.onrender.com/auth/google/callback",
