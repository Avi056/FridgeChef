...
export const env = {
  ...
  clientUrl: process.env.CLIENT_URL || "https://fridgecraft.netlify.app",
  sessionSecret: process.env.SESSION_SECRET || "dev-fridgechef-session-secret",
  googleClientId: process.env.GOOGLE_CLIENT_ID,
  googleClientSecret: process.env.GOOGLE_CLIENT_SECRET,
  googleCallbackUrl:
    process.env.GOOGLE_CALLBACK_URL || `${process.env.CLIENT_URL || "https://fridgecraft.netlify.app"}/auth/google/callback`,
